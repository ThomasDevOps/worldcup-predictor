-- World Cup 2026 Predictor - Scoring Trigger
-- Automatically calculates points when match status changes to 'finished'

-- Scoring system:
-- - Exact score: 10 points
-- - Correct winner: 5 points
-- - Draw bonus: +4 points (if correctly predicted a draw)
-- - Wrong: 0 points
-- Maximum: 14 points (exact draw + draw bonus)
